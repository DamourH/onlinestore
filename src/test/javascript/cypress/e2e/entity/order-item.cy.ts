...
describe('OrderItem e2e test', () => {
  ...
  const orderItemSample = { quantity: 29664, totalPrice: 23069.19, status: 'AVAILABLE' };
  ...
  describe('new OrderItem page', () => {
    ...
    it('should create an instance of OrderItem', () => {
      cy.get(`[data-cy="quantity"]`).type('26139');
      cy.get(`[data-cy="quantity"]`).should('have.value', '26139');

      cy.get(`[data-cy="totalPrice"]`).type('16097.85');
      cy.get(`[data-cy="totalPrice"]`).should('have.value', '16097.85');
