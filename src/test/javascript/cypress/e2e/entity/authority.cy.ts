...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'ecf29991-5e22-4930-8b20-53f456ab209a' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('a8c33634-0e8b-4687-bf72-48c76770674b');
      cy.get(`[data-cy="name"]`).should('have.value', 'a8c33634-0e8b-4687-bf72-48c76770674b');
