...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'bah after er' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('wisely');
      cy.get(`[data-cy="name"]`).should('have.value', 'wisely');

      cy.get(`[data-cy="description"]`).type('warming pasta dead');
      cy.get(`[data-cy="description"]`).should('have.value', 'warming pasta dead');
