...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'impossible', price: 29950.12, prosuctSize: 'L' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('round well');
      cy.get(`[data-cy="name"]`).should('have.value', 'round well');

      cy.get(`[data-cy="description"]`).type('phooey phew');
      cy.get(`[data-cy="description"]`).should('have.value', 'phooey phew');

      cy.get(`[data-cy="price"]`).type('26457.4');
      cy.get(`[data-cy="price"]`).should('have.value', '26457.4');

      cy.get(`[data-cy="prosuctSize"]`).select('M');
