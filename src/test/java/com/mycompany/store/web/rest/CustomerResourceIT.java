...
import static com.mycompany.store.domain.CustomerAsserts.*;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "||^9`Y@Ck,,.yv$,N";
    private static final String UPDATED_EMAIL = "NU@F}.2?tyI";
