...
import static com.mycompany.store.domain.ProductAsserts.*;
...
class ProductResourceIT {
    ...
    private static final Size DEFAULT_PROSUCT_SIZE = Size.S;
    private static final Size UPDATED_PROSUCT_SIZE = Size.M;
    ...
    public static Product createEntity() {
        return new Product()
            ...
            .price(DEFAULT_PRICE)
            .prosuctSize(DEFAULT_PROSUCT_SIZE)
            .image(DEFAULT_IMAGE)
    ...
    public static Product createUpdatedEntity() {
        return new Product()
            ...
            .price(UPDATED_PRICE)
            .prosuctSize(UPDATED_PROSUCT_SIZE)
            .image(UPDATED_IMAGE)
    ...
    @Test
    @Transactional
    void checkProsuctSizeIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        int searchDatabaseSizeBefore = IterableUtil.sizeOf(productSearchRepository.findAll());
        // set the field null
        product.setProsuctSize(null);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].prosuctSize").value(hasItem(DEFAULT_PROSUCT_SIZE.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.prosuctSize").value(DEFAULT_PROSUCT_SIZE.toString()))
