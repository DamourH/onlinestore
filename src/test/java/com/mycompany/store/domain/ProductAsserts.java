...
public class ProductAsserts {
    ...
    public static void assertProductUpdatableFieldsEquals(Product expected, Product actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getProsuctSize()).as("check prosuctSize").isEqualTo(expected.getProsuctSize()))
    ...
    public static void assertProductUpdatableRelationshipsEquals(Product expected, Product actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getProductCategories()).as("check productCategories").isEqualTo(expected.getProductCategories()));
    }
}
