...
/**
 * Service Implementation for managing {@link com.mycompany.store.domain.Product}.
 */
@Service
@Transactional
    ...
    public Optional<Product> partialUpdate(Product product) {
        ...
        return productRepository
            ...
            .map(existingProduct -> {
                ...
                if (product.getProsuctSize() != null) {
                    existingProduct.setProsuctSize(product.getProsuctSize());
                }
