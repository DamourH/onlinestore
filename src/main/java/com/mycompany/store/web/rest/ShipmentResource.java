...
import com.mycompany.store.web.rest.errors.ElasticsearchExceptionMapper;
...
public class ShipmentResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Shipment>> getAllShipments(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
    ...
    /**
     * {@code SEARCH  /shipments/_search?query=:query} : search for the shipment corresponding
     * to the query.
     *
