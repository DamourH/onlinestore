...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../product-order.test-samples';
...
describe('ProductOrder Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should handle exceptions for searching a ProductOrder', () => {
