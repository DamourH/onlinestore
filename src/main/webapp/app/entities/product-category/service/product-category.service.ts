...
export class ProductCategoryService {
  ...
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/product-categories/_search');
  ...
  search(req: Search): Observable<EntityArrayResponseType> {
    ...
    return this.http
      ...
      .pipe(catchError(() => scheduled([new HttpResponse<IProductCategory[]>()], asapScheduler)));
  }
